      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="order-2 md:order-1 relative">
          ...
          <div className="flex gap-10 mt-10 pt-6 border-t border-gray-100">
            <div>
              <div className="text-2xl font-black text-gray-900 leading-none">2026</div>
              <div className="text-[9px] text-orange-500 font-black uppercase tracking-widest mt-1.5">Award Year</div>
            </div>
            <div>
              <div className="text-2xl font-black text-gray-900 leading-none">10th</div>
              <div className="text-[9px] text-orange-500 font-black uppercase tracking-widest mt-1.5">Decade Celebration</div>
            </div>
          </div>
        </div>
